...
Logics for which the bidirectional translation between proofs and algebraic equations, so that it is possible to fully represent logical inference using algebraic reasoning, are called algebraizable.\cite[Def.~2.10]{BlokPigozzi1989}.
