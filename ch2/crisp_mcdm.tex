...
Pairwise comparison methods (e.g., AHP, ANP, BWM)
...
\say{MCDM  methods  provide  a  systematic  and  structured framework  for  decision-making.  They  enable  decision-makers  to  break  down  complex problems  into  a  set  of  criteria,  evaluate  alternatives  against  these  criteria,  and  make informed choices based on well-defined decision rules.}\footnote{\href{https://www.dma-journal.org/index.php/dema/article/view/7/5}{https://www.dma-journal.org/index.php/dema/article/view/7/5}}
\\
...
\signal{Aquí quiero decir cómo los clasificamos y por qué. Me gustaría una clasificación que recoja la idea general de los métodos. Cojo la clasificación de Belton and Stewart (2002)? value measurement, goal
aspirations or reference level, and outranking methods}
