This section provides the foundational definitions and usual mathematical formalization of Multi-Criteria Decision-Making (MCDM) as discussed in \cite{handbookmcdm}. According to \cite{Sahoo_Goswami_2023}:
...
\begin{figure}[htbp]
    ...
    \end{tikzpicture}
    \caption{Classification of MCDM Methods following Belton and Stewart (2002).}
