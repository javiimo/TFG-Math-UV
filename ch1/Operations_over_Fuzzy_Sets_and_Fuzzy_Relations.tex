...
\begin{example}
  ...
  \begin{itemize}
    ...
    \item \textbf{Weak/Strong:}
    The smallest t-norm ($T_D$) and the largest t-conorm ($S_D$). They represent the most extreme intersection and union possible. Discontinuous except at boundary points (0,0), (1,1), etc. \\
