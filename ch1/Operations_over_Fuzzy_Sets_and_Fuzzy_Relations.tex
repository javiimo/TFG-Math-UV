...
However, this notion can be generalized by two classes of operators: triangular norms (intersection) and triangular conorms (union). Where the later is completely analogous to the later. This concepts where first introduced by Karl Menger in 1942 \cite{OriginTNorms} \signal{por las propiedades de lo que debería ser y para lo de la triangular norm}
