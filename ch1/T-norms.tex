...
\remark{It can be shown that thanks to the one identity and the monotonicity, all t-norms are identical in the boundary of $[0,1]^2$. In particular, they are the same in $\{0,1\}^2$, which is why any t-norm restricted to a boolean domain is the same as the classical intersection.}
